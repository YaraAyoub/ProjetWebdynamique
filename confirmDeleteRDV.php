...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div id="section">
      ...
      <img src="imagesDeco/suppression.png" alt="OMNES SANTE" width="200" height="220" style="position:absolute;top:300px; left: 200px"/>
      ...
      <div id="confirmation" style ="display:block;
        ...
        <h1>Confirmation de la suppression de votre RDV </h1>

        <?php

          $nomMedecin = $_POST["choixDocDeleteRDV"];
          $dateHeure = $_POST["choixDateDeleteRDV"];
          ...
          if ($db_found) {
            ...
            $sql="UPDATE `rendezvous`  SET `idClient` = NULL WHERE `rendezvous`.`NomMedecin` = '$nomMedecin' AND `rendezvous`.`DateHeure`= '$dateHeure'; ";
